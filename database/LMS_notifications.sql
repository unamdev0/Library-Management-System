...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`M_Id`),
  KEY `RollNo` (`RollNo`),
  CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`RollNo`) REFERENCES `user` (`RollNo`)
