...
<header class="header">
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <?php
                ...
                $sql="select count(*) as count from LMS.message where RNo like '$name'";
            ...
            <div class="right-menu list-inline no-margin-bottom">
                <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1"><?php echo $count?></span></a>
                    <div aria-labelledby="navbarDropdownMenuLink1" style="overflow: hidden; max-width:500px" class="dropdown-menu messages">
                        <?php
                        $name=$_SESSION['RollNo'];
                        $sql="select * from LMS.message where RNo like '$name' order by Date desc, Time Desc";
                        $result=$conn->query($sql);
                        while($row=$result->fetch_assoc())
                        {
                            ...
                            <a href="#" class="dropdown-item message d-flex align-items-center">
                                <div class="profile"><img src="img/profile.png" alt="..." class="img-fluid">
    ...
    <nav id="sidebar">
        ...
        <span class="heading index_side">Main</span>
        <ul class="list-unstyled index_side">
            ...
            <li><a href="#exampledropdownDropdown1" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>My Profile</a>
                <ul id="exampledropdownDropdown1" class="collapse  list-unstyled ">
                    ...
                    <li><a href="view_details_admin.php">Update Details</a></li>
                    <!--<li><a href="#">Page</a></li>-->
                </ul>
            </li>
            ...
            <li><a href="#exampledropdownDropdown5" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Member Requests</a>
                <ul id="exampledropdownDropdown5" class="collapse list-unstyled ">
                    <li><a href="issue_book.php">Requested Book</a></li>
