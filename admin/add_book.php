...
/*if(isset($_POST['submit']))
{
    ...
    $sql1="insert into LMS.book (RollNo,Msg,Date,Time) values ('$rollno','$message',curdate(),curtime())";

if($conn->query($sql1) === TRUE){
    echo "<script type='text/javascript'>document.getElementById('incorrect').innerText = 'Message Sent' </script>";
}
else
{//echo $conn->error;
    echo "<script type='text/javascript'>document.getElementById('incorrect').innerText = 'Invalid Member Id'</script>";
}
