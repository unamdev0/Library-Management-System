...
if ($_SESSION['RollNo']) {
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="select * from lms.record where $t like '$s' AND Date_Of_Return IS NOT NULL AND Date_of_Issue IS NOT NULL AND Due_Date IS NOT NULL  order by BookId ASC";
    }
    else
        $sql="select * from lms.record where Date_Of_Return IS NOT NULL AND Date_of_Issue IS NOT NULL AND Due_Date IS NOT NULL order by BookId ASC ";
    //echo $sql;
