...
<div class="login-page">
                ...
                <div class="content">
                  <form class="text-left form-validate" method="post" action="register.php" >
                      <div class="form-group-material">
                          <select name="registerCategory" style="width: 400px;height: 40px;background: none;color: pink;border: none;" class="label-material">
                    ...
                    <div class="form-group-material">
                      ...
                      <div class="form-group-material">
                          <input id="register-name" type="text" name="registerName" required data-msg="Please enter your Full Name" class="input-material">
                          <label for="register-Name" class="label-material">Name</label>
                      </div>
                      <div class="form-group-material">
                          <input id="register-Mobile" type="number" name="registerMobile" required data-msg="Please enter your Mobile Number" class="input-material">
                    ...
                    <label class="text-primary" id="incorrect"></label></a>
    ...
    <?php
        if(isset($_POST['register']))
        {
            ...
            $mobno=$_POST['registerMobile'];
            $rollno=$_POST['registerUsername'];
            $type=$_POST['registerCategory'];

            $sql="insert into LMS.user (Name,Type,RollNo,EmailId,MobNo,Password) values ('$name','$type','$rollno','$email','$mobno','$password')";

            if ($conn->query($sql) === TRUE) {
                echo "<script type='text/javascript'>document.getElementById('incorrect').innerText = 'Registration Successfull'</script>";
            } else {
                    //echo "Error: " . $sql . "<br>" . $conn->error;
                echo "<script type='text/javascript'>document.getElementById('incorrect').innerText = 'User Already Exits' </script>";
            }
        }
    ?>
    <!-- JavaScript files-->
