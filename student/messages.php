        ...
        <div class="container-fluid">
          <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
              <li class="breadcrumb-item active"><a style="color: #585a5f" href="messages.php">Inbox</a></li>
          </ul>
        </div>
              ...
              <div class="public-user-block block">
                  <div class="input-group">
                      ...
                      <select name="account" id="account" class="form-control mb-3 mb-3" style=" max-width: 200px;">
                          <option selected value="SNo">Member Id</option>
                ...
                //echo $t;
                //echo $s;
                      $sql="select * from lms.message m  join lms.user u on m.RNo=u.RollNo where RNo='$name' and $t like'$s'order by Date DESC,Time DESC";}
                else
                      $sql="select * from lms.message m  join lms.user u on m.RNo=u.RollNo where RNo='$name' order by Date DESC,Time DESC";
                //echo $sql;
