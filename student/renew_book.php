...
if ($_SESSION['RollNo']) {
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="select RollNo,BookId,Date_of_Issue,Renew_Date from lms.record where $t like '$s' and Renew_Date is not null and RollNo='$no' by BookId ASC";
    }
    else
        $sql="select RollNo,BookId,Date_of_Issue,Renew_Date from lms.record where Renew_Date is not null and RollNo='$no' order by BookId ASC ";
    //echo $sql;
