    ...
    <div class="page-content">
        ...
        <section class="no-padding-top">
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql="select BookId,Renewals_left,Date_of_Issue,Date_of_Return,DATEDIFF(curdate(),Due_Date) as diff from lms.record where $t like '$s' AND Date_of_Issue IS NOT NULL AND Date_of_Return IS NOT NULL And RollNo='$d' order by BookId ASC";
            }
            else
                $d=$_SESSION['RollNo'];
            $sql="select BookId,Renewals_left,RollNo,Date_of_Issue,Date_of_Return,DATEDIFF(curdate(),Due_Date) as diff from lms.record where Date_of_Issue IS NOT NULL AND Date_of_Return IS NOT NULL And RollNo='$d'  order by BookId ASC";
            //echo $sql;
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="text-primary">Returned Date</th>
